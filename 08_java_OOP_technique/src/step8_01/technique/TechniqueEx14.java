...
//	void test() {
//		for (int i = 0; i < 10; i++) {
//			System.out.println("음악 프로그램이 실행되는 중");
//		}
//	}
...
public class TechniqueEx14 {
	...
	public static void main(String[] args) {
		...
		musicPlay.start();  // run 메서드는 start로 실행함.
		
		Movie moviePlay = new Movie();
		moviePlay.start();
		...
		Game temp = new Game();
		Thread gameRun = new Thread(temp);
		gameRun.start();
